    ...
    switch (p)
        ...
        case 6:
            return -3.75 * x + 26.25 * std::pow (x, 3) - 47.25 * std::pow (x, 5)
                   + 24.75 * std::pow (x, 7);
        case 7:
            return 0.546875 - 15.3125 * std::pow (x, 2)
                   + 68.90625 * std::pow (x, 4) - 101.0625 * std::pow (x, 6)
                   + 46.921875 * std::pow (x, 8);
        case 8:
        ...
        case 16:
            return 6.2841796875 * x - 284.8828125 * std::pow (x, 3)
                   + 3788.94140625 * std::pow (x, 5)
                   - 22733.6484375 * std::pow (x, 7)
    ...
    switch (p)
        ...
        case 10:
            return -4.921875 + 270.703125 * std::pow (x, 2)
                   ...
                   - 8546.484375 * std::pow (x, 8)
                   + 3608.515625 * std::pow (x, 10);
        case 11:
            return -59.5546875 * x + 1290.3515625 * std::pow (x, 3)
                   - 7742.109375 * std::pow (x, 5)
                   + 18802.265625 * std::pow (x, 7)
                   - 19846.8359375 * std::pow (x, 9)
                   + 7577.8828125 * std::pow (x, 11);
        case 12:
            return 5.4140625 - 422.296875 * std::pow (x, 2)
                   + 5278.7109375 * std::pow (x, 4)
                   - 23930.15625 * std::pow (x, 6)
                   + 48714.9609375 * std::pow (x, 8)
                   - 45467.296875 * std::pow (x, 10)
...
{
    if (shapeFct.compare ("standard shape function"))
        {
            ...
            return { Eigen::VectorXd::Map (n_vec.data (), n_vec.size ()),
                     n_mat };
        }
    else if (shapeFct.compare ("hierarchical shape function"))
        {
            std::vector<double> n_vec;
            Eigen::MatrixXd n_mat (2, 0);
