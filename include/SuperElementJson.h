/**
 * \file   SuperElementJson.h
 * \author Roman Wallner- Silberhuber
 * \date   21.05.23
 * \brief  This head contains the SuperElementJson class
 */

#ifndef SBFEM_SUPERELEMENT_JSON_H
#define SBFEM_SUPERELEMENT_JSON_H
...
/**
 * @class SuperElementJson
 * @brief A class representing a SuperElementJson with various properties.
 */
class SuperElementJson
{
private:

    // naming convention: m_SE_SE_ for member Variables of the SuperElementJson class
...
public:
    ...
    explicit SuperElementJson(const nlohmann::json& json);
    ...
    /**
     * @brief Overloaded output stream operator for SuperElementJson class.
     *
     * This operator allows the SuperElementJson objects to be easily printed using the
     * standard output stream.
     *
     * @param os The output stream.
     * @param sEt The object of SuperElementJson class to be printed.
     * @return std::ostream& The modified output stream with the SuperElementJson printed.
     */
    friend std::ostream& operator << (std::ostream& os, const SuperElementJson & sEt);
};
...
#endif //SBFEM_SUPERELEMENT_JSON_H
